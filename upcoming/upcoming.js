const upcomingMovies =
    'https://api.themoviedb.org/3/movie/upcoming?language=pt&page=1&region=pt'
...
fetch(upcomingMovies, options)
    ...
    .then(response => {
        ...
        movies.forEach((value, index) => {
            ...
            pReleaseDate.classList.add('releaseDate')
            pReleaseDate.innerHTML =
                'Data de Lançamento: ' + movies[index].release_date
            divInfo.appendChild(pReleaseDate)
